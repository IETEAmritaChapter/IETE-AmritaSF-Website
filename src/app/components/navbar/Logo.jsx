...
export default function Logo() {
  return (
    <div className="flex items-center gap-3 text-lg [font-family:var(--font-montserrat)]">
      <img
        loading="lazy"
        ...
        className="object-contain aspect-square w-16 md:w-24"
      ...
      <div>
        ...
        <br />
        <span className="text-orange-400 text-sm md:text-lg">
          Amrita Coimbatore
        </span>
      </div>
    </div>
