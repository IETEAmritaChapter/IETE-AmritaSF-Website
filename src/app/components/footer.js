...
const Footer = () => {
  return (
    <div className="footer w-full text-black bg-white px-4 sm:px-12 py-0">
      <div className="flex flex-wrap justify-between items-center sm:px-12 max-md:flex-col max-md:items-center max-md:text-center max-md:space-y-4">
        {/* Left Section */}
        <div className="left flex flex-col justify-center mb-2 sm:mb-0 max-md:items-center">
          <h2 className="text-[28px] sm:text-[40px] font-[montserrata]">Let's Connect !</h2>
