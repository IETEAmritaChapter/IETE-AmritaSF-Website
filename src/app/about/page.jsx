export default function Home() {
  return (
    <div className="body gap-6">
      {/* Navbar Section */}
      <div className="navbar w-full flex justify-center items-center text-xl gap-4 font-bold font-[montserratb]">
      </div>

      {/* About Section */}
      <section className="about flex flex-col gap-4 items-center">
        <h1 className="text-2xl font-bold font-[montserratb]">ABOUT IETE AMRITA</h1>
        <div className="message-box text-black p-6 bg-white rounded-lg text-start font-[montserrat]">
      ...
      <section className="why-what w-full flex flex-col gap-4 justify-center items-center text-center mt-6">
        <h2 className="text-2xl font-bold font-[montserratb]">
          <span className="text-orange-600">WHY</span> WE DO <span className="text-orange-600">WHAT</span> WE DO
        </h2>
        <p className="text-gray-400 montserrat-alternates text-start font-[montserrat]">
        ...
        <div className="box-wrapper flex flex-wrap md:flex-nowrap flex-col md:flex-row justify-center items-stretch gap-4 w-full">
          ...
          <div className="box-container bg-white p-4 border rounded shadow text-black flex-1 min-h-[150px]">
            <div>
              <h2 className="text-xl font-bold text-start text-orange-600 font-[montserratb]">MISSION</h2>
            </div>
            <p className="text-start font-[montserrat]">
          ...
          <div className="box-container bg-white p-4 border rounded shadow text-black flex-1 min-h-[150px]">
            <div>
              <h2 className="text-xl font-bold text-start text-orange-600 font-[montserratb]">VISION</h2>
            </div>
            <p className="text-start font-[montserrat]">
      ...
      {/* Verticals Section */}
      <section className="verticals w-full flex flex-col gap-4 items-center text-center mt-6">
        <h2 className="text-2xl font-bold font-[montserratb]">
      ...
      {/* Join Section */}
      <section className="join w-full flex flex-col gap-4 items-center text-center mt-6">
        <h2 className="text-2xl font-bold font-[montserratb]">
