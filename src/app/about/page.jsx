export default function Home() {
    return (
      <div className="body w-screen min-h-screen bg-white flex justify-center items-center montserrat">
        <div className="content-container bg-black text-white mx-6 my-6 p-6 rounded-lg shadow-lg flex flex-col items-center gap-6">
